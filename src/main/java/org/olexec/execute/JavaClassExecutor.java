 ...
 *      java/lang/System -> com/jvm/ch9/jvm/remoteinvoke/HackSystem
...
public class JavaClassExecutor {
    ...
    public static String execute(byte[] classBytes, String systemIn) {
        ...
        //3.调用ClassModofier#modifyUTF8Constant修改 org.olexec.execute.HackSystem
        byte[] modifyBytes = classModifier.modifyUTF8Constant("java/lang/System", "org/olexec/execute/HackSystem");
        modifyBytes = classModifier.modifyUTF8Constant("java/util/Scanner", "org/olexec/execute/HackScanner");
