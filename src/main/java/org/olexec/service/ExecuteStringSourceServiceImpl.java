...
public class ExecuteStringSourceServiceImpl implements ExecuteStringSourceService {
    ...
    private static final ExecutorService pool = new ThreadPoolExecutor(N_THREAD,
            N_THREAD, 0L, TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(N_THREAD));
    ...
    public String execute(String source, String systemIn) {
        ...
        if (classBytes == null) {
            ...
            for (Diagnostic<? extends JavaFileObject> diagnostic : compileError) {
                ...
                compileErrorRes.append(diagnostic.getColumnNumber());
        ...
        //运行字节码的main方法
        Callable<String> runTast = new Callable<String>() {
            @Override
